...
module.exports = {
    ...
    RG: process.env.RG || '923068284384-1632403322@g.us,120363116963909366@g.us',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "USAIMKHAN",
    BOT_NAME: process.env.BOT_NAME || 'USAIMKHAN',
